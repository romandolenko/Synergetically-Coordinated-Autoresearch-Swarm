...
> Consolidated write-up. Day-by-day detail in [`results-day3.md`](results-day3.md) and [`results-day4.md`](results-day4.md). **Post-review hardening (fair controls, performance-aware variant, validated embedding mitigation) in [`results-review.md`](results-review.md) — read it before acting on the headline ACs.** Spec docs: [`requirements.md`](requirements.md), [`design.md`](design.md), [`tasklist.md`](tasklist.md).
